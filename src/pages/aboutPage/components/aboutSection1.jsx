...
export default function AboutSection1(){
    return(
        <div className="bg-contain bg-no-repeat bg-center " style={{backgroundImage: `url(${bgCloud})`}}>
            ...
            <div data-aos="fade-up" className="bg-contain bg-no-repeat bg-center flex justify-center w-[240px] h-full p-1 m-1" style={{ backgroundImage: `url(${titleFrame})` }}>
...
魂牽夢縈；日夜交錯。<br/>
在這片黑暗與光明交織的時空中，舉杯，沈睡。<br/>
靜謐中，旋律輕柔地流淌，化作夢的呢喃。<br/>
映射我們內心深處的渴望與追求，是追尋未來的夢想，是回味過去的美好。<br/>
我們在這片寧靜的夜空下，試著觸碰夢的邊緣。隨音樂共舞，與夢相伴，尋找內心深處的光芒。<br/>
潮汐之間，長退相偎。<br/>
你我，沈醉於聲。</p>
            </div>
            <div className="absolute right-0 w-[28%] -bottom-[70%] max-lg:-bottom-[40%] max-lg:opacity-60 max-lg:w-[35%] max-md:-bottom-[30%] max-md:w-[50%]"><img src={redRight} alt="red string"/></div>
            </div>
        </div>
    )
}