...
export default function AboutSection03() {
   return(
    <div className="bg-contain bg-no-repeat bg-top mb-48" style={{backgroundImage: `url(${bgCloud01})`}}>
        <div className="bg-contain bg-no-repeat bg-bottom" style={{backgroundImage: `url(${bgCloud02})`}}>
        <div className="pb-40 max-lg:pb-28">
            <p className="SectionTitle tracking-[5px] text-center">籌備團隊</p>
            <p className="TsaiYin text-center pt-1">&#123;采音吉他社&#125;</p>
        </div>
        <div className="bg-contain bg-no-repeat bg-center" style={{backgroundImage: `url(${BigRed})`}}>
