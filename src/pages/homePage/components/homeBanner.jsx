...
export default function HomeBanner() {
    return(
        ...
        <div>
        <img src={rightCloud} className="absolute right-16 top-72 w-[28%] animate-MoveHorizontal1 hover:blur-[1px]" alt="RedStringcloud"/>
        </div>
        <div>
        <img src={leftCloud} className="absolute left-0 bottom-24 w-[25%]  animate-MoveHorizontal2 hover:blur-[1px]" alt="RedStringcloud"/>
        </div>
        </div>
