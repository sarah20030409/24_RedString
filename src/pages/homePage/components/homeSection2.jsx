...
export default function HomeSection2() {
    return(
        <div className="flex justify-center w-full  pt-44 max-lg:pt-24 ">
            ...
            <iframe className="w-full max-md:hidden" height={700} src="https://www.youtube.com/embed/BKJsoaxAt8E?si=wwuQ1ke05R_GgopR&amp;controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            <iframe className="w-full md:hidden" height={400} src="https://www.youtube.com/embed/BKJsoaxAt8E?si=wwuQ1ke05R_GgopR&amp;controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
    ) 
}