...
export default function Footer(){
    return(
        <div className=" bg-right bg-contain bg-no-repeat overflow-hidden" style={{backgroundImage: `url(${footerCloud})`}}>
            <div className="border-y-[0.7px] border-solid border-RSgoldLight flex justify-between items-end py-10 px-[10%]" >
                ...
                <div className="flex justify-center  place-items-end" data-aos="fade-left">
